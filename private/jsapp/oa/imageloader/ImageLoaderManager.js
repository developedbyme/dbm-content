...
//import ImageLoaderManager from "oa/imageloader/ImageLoaderManager";
export default class ImageLoaderManager {
	
	constructor() {
		//console.log("oa/imageloader/ImageLoaderManager::constructor");
	...
	_callback_resize(aEvent) {
		//console.log("oa/imageloader/ImageLoaderManager::_callback_resize");
		
		this.updateAllInitiatedImages();
	}
	
	_callback_scroll(aEvent) {
		//console.log("oa/imageloader/ImageLoaderManager::_callback_scroll");
		
		this.updateAllUninitiatedImages();
	}
	
	findAndRegisterImages(aElement) {
		//console.log("oa/imageloader/ImageLoaderManager::findAndRegisterImages");
	...
	registerElement(aElement, aData, aSettings) {
		//console.log("oa/imageloader/ImageLoaderManager::registerElement");
	...
	start() {
		//console.log("oa/imageloader/ImageLoaderManager::start");
