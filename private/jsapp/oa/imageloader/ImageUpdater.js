...
export default class ImageUpdater {
	...
	constructor() {
		//console.log("oa/imageloader/ImageUpdater::constructor");
	...
	setupData(aElement, aData, aSettings) {
		//console.log("oa/imageloader/ImageUpdater::setupData");
	...
	_getBestImageData(aWidth, aHeight, aCrop) {
		//console.log("oa/imageloader/ImageUpdater::_getBestImageData");
	...
	setOwner(aOwner) {
		//console.log("oa/imageloader/ImageUpdater::setOwner");
		this._owner = aOwner;
	...
	shouldActivate(aScrollX, aScrollY, aPreparationLength) {
		//console.log("oa/imageloader/ImageUpdater::shouldActivate");
	...
	_render(aImage) {
		//console.log("oa/imageloader/ImageUpdater::_render");
	...
	update() {
		//console.log("oa/imageloader/ImageUpdater::update");
	...
	updateRatio() {
		//console.log("oa/imageloader/ImageUpdater::updateRatio");
		
		//MENOTE: should be overridden
	}
	
	static create(aElement, aData, aSettings, aOwner) {
		//console.log("oa/imageloader/ImageUpdater::create");
