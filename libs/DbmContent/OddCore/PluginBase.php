<?php
	namespace DbmContent\OddCore;

	// \DbmContent\OddCore\PluginBase
	class PluginBase {
		...
		protected function register_lists() {
			//echo("\DbmContent\OddCore\PluginBase::register_lists<br />");
		...
		protected function create_pages() {
			echo("\DbmContent\OddCore\PluginBase::create_pages<br />");

			//MENOTE: should be overridden
		}

		protected function register_pages() {
			//echo("\DbmContent\OddCore\PluginBase::register_pages<br />");
		...
		protected function add_additional_hook($additional_hook) {
			//echo("\DbmContent\OddCore\PluginBase::add_additional_hook<br />");

			$this->_additional_hooks[] = $additional_hook;
		}

		protected function create_additional_hooks() {
			//echo("\DbmContent\OddCore\PluginBase::create_additional_hooks<br />");

			//MENOTE: should be overridden
		}

		protected function register_additional_hooks() {
			//echo("\DbmContent\OddCore\PluginBase::register_additional_hooks<br />");
		...
		protected function get_additional_hooks() {
			//echo("\DbmContent\OddCore\PluginBase::get_additional_hooks<br />");
		...
		protected function add_custom_post_type($custom_post_type) {
			//echo("\DbmContent\OddCore\PluginBase::add_custom_post_type<br />");

			$this->_custom_post_types[$custom_post_type->get_system_name()] = $custom_post_type;
		}

		protected function create_custom_post_types() {
			//echo("\DbmContent\OddCore\PluginBase::create_custom_post_types<br />");

			//MENOTE: should be overridden
		}

		protected function register_custom_post_types() {
			//echo("\DbmContent\OddCore\PluginBase::register_custom_post_types<br />");
		...
		protected function add_filter($filter) {
			//echo("\DbmContent\OddCore\PluginBase::add_filter<br />");

			$this->_filters[] = $filter;
		}

		protected function create_filters() {
			//echo("\DbmContent\OddCore\PluginBase::create_filters<br />");

			//MENOTE: should be overridden
		}

		protected function register_filters() {
			//echo("\DbmContent\OddCore\PluginBase::register_filters<br />");
		...
		protected function get_pages() {
			//echo("\DbmContent\OddCore\PluginBase::get_pages<br />");
		...
		protected function get_custom_post_types() {
			//echo("\DbmContent\OddCore\PluginBase::custom_post_types<br />");
		...
		protected function get_filters() {
			//echo("\DbmContent\OddCore\PluginBase::get_filters<br />");
		...
		protected function register_ajax_api_end_points() {
			//echo("\DbmContent\OddCore\PluginBase::register_ajax_api_end_points<br />");
		...
		protected function get_ajax_api_end_points() {
			//echo("\DbmContent\OddCore\PluginBase::get_ajax_api_end_points<br />");
		...
		protected function create_rest_api_end_points() {
			//echo("\DbmContent\OddCore\PluginBase::create_rest_api_end_points<br />");

			//MENOTE: should be overridden
		}

		protected function register_rest_api_end_points() {
			//echo("\DbmContent\OddCore\PluginBase::register_rest_api_end_points<br />");
		...
		protected function get_rest_api_end_points() {
			//echo("\DbmContent\OddCore\PluginBase::get_rest_api_end_points<br />");
		...
		protected function add_shortcode($shortcode) {
			//echo("\DbmContent\OddCore\PluginBase::add_shortcode<br />");

			$this->_shortcodes[] = $shortcode;
		}

		protected function create_shortcodes() {
			//echo("\DbmContent\OddCore\PluginBase::create_shortcodes<br />");

			//MENOTE: should be overridden
		}

		protected function register_shortcodes() {
			//echo("\DbmContent\OddCore\PluginBase::register_shortcodes<br />");
		...
		protected function get_shortcodes() {
			//echo("\DbmContent\OddCore\PluginBase::get_shortcodes<br />");
		...
		protected function add_meta_box($system_name, $box, $post_type = 'post', $context = 'advanced', $priority = 'default') {
			$new_registration = new \DbmContent\OddCore\Admin\MetaData\PostMetaDataBoxRegistration();
		...
		protected function create_meta_boxes() {
			//echo("\DbmContent\OddCore\PluginBase::create_meta_boxes<br />");

			//MENOTE: should be overridden
		}

		protected function register_meta_boxes() {
			//echo("\DbmContent\OddCore\PluginBase::register_meta_boxes<br />");
		...
		protected function get_meta_boxes() {
			//echo("\DbmContent\OddCore\PluginBase::get_meta_boxes<br />");
		...
		public function register_hooks() {
			//echo("\DbmContent\OddCore\PluginBase::register_hooks<br />");
		...
		public function hook_admin_menu() {
			//echo("\DbmContent\OddCore\PluginBase::hook_admin_menu<br />");
		...
		public function hook_admin_enqueue_scripts() {
			//echo("\DbmContent\OddCore\PluginBase::hook_admin_enqueue_scripts<br />");
		...
		public function hook_rest_api_init() {
			//echo("\DbmContent\OddCore\PluginBase::hook_rest_api_init<br />");
		...
		public function hook_edit_form_after_title() {
			//echo("\DbmContent\OddCore\PluginBase::hook_edit_form_after_title<br />");
		...
		public function hook_edit_form_after_editor() {
			//echo("\DbmContent\OddCore\PluginBase::hook_edit_form_after_editor<br />");
		...
		public function hook_save_post($post_id, $post, $update) {
			//echo("\DbmContent\OddCore\PluginBase::hook_save_post<br />");
