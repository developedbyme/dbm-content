<?php
	namespace DbmContent\OddCore\RestApi;
	
	use \WP_Query;
	use DbmContent\OddCore\RestApi\EndPoint as EndPoint;
	
	// \DbmContent\OddCore\RestApi\BatchTrashPostsEndPoint
	class BatchTrashPostsEndPoint extends EndPoint {
		...
		public function perform_call($data) {
			...
			remove_action( 'transition_post_status',           array( '\DbmContent\Helper\Headlines', 'transition_post_status' ), 10, 3 );
			remove_action( 'transition_post_status',           array( '\DbmContent\Helper\PartnerPromotion', 'transition_post_status' ), 10, 3 );
