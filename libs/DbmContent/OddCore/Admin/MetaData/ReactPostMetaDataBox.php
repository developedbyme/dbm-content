<?php
	...
	use \DbmContent\OddCore\Admin\MetaData\PostMetaDataBox;
	
	// \DbmContent\OddCore\Admin\MetaData\ReactPostMetaDataBox
	class ReactPostMetaDataBox extends PostMetaDataBox {
		...
		function __construct() {
			...
			//$portrait_image_meta_field = new \DbmContent\OddCore\Admin\MetaData\MetaField();
		...
		public function output_box_start($post) {
			?>
				<div id="post-metadata" class="postbox">
					<h3><span><?php _e($this->_display_name, DBM_CONTENT_TEXTDOMAIN) ?></span></h3>
