<?php
	namespace DbmContent\OddCore\Admin\CustomPostTypes;
	
	// \DbmContent\OddCore\Admin\CustomPostTypes\CustomPostTypePost
	class CustomPostTypePost {
		...
		public function setup_labels_autonaming($name) {
			...
			$this->_labels = array(
				'name' => __( ucfirst($multiple_name), DBM_CONTENT_TEXTDOMAIN ),
				'singular_name' => __( ucfirst($name), DBM_CONTENT_TEXTDOMAIN ),
				'menu_name' => __( ucfirst($multiple_name), DBM_CONTENT_TEXTDOMAIN ),
				'name_admin_bar' => __( ucfirst($name), DBM_CONTENT_TEXTDOMAIN ),
				'add_new' => __( 'Add New', DBM_CONTENT_TEXTDOMAIN ),
				'add_new_item' => __( 'Add New '.ucfirst($name), DBM_CONTENT_TEXTDOMAIN ),
				'edit_item' => __( 'Edit '.ucfirst($name), DBM_CONTENT_TEXTDOMAIN ),
				'new_item' => __( 'New '.ucfirst($name), DBM_CONTENT_TEXTDOMAIN ),
				'all_items' => __( 'All '.ucfirst($multiple_name), DBM_CONTENT_TEXTDOMAIN ),
				'view_item' => __( 'View '.ucfirst($name), DBM_CONTENT_TEXTDOMAIN ),
				'search_items' => __( 'Search '.ucfirst($multiple_name), DBM_CONTENT_TEXTDOMAIN ),
				'not_found' => __( 'No '.$multiple_name.' found', DBM_CONTENT_TEXTDOMAIN ),
				'not_found_in_trash' => __( 'No '.$multiple_name.' found in trash', DBM_CONTENT_TEXTDOMAIN ),
				'parent_item_colon'     => __( 'Parent '.ucfirst($name).':', DBM_CONTENT_TEXTDOMAIN ),
				'archives'              => __( ucfirst($name).' Archives', DBM_CONTENT_TEXTDOMAIN ),
				'edit_item'             => __( 'Edit '.ucfirst($name), DBM_CONTENT_TEXTDOMAIN ),
				'update_item'           => __( 'Update '.ucfirst($name), DBM_CONTENT_TEXTDOMAIN ),
				'view_item'             => __( 'View '.ucfirst($name), DBM_CONTENT_TEXTDOMAIN ),
				'search_items'          => __( 'Search '.ucfirst($multiple_name), DBM_CONTENT_TEXTDOMAIN ),
				'items_list'            => __( ucfirst($multiple_name).' list', DBM_CONTENT_TEXTDOMAIN ),
				'items_list_navigation' => __( ucfirst($multiple_name).' list navigation', DBM_CONTENT_TEXTDOMAIN ),
				'filter_items_list'     => __( 'Filter '.ucfirst($multiple_name).' list', DBM_CONTENT_TEXTDOMAIN )
			);
			
			//'featured_image'        => __( 'Featured Image', DBM_CONTENT_TEXTDOMAIN ),
			//'set_featured_image'    => __( 'Set featured image', DBM_CONTENT_TEXTDOMAIN ),
			//'remove_featured_image' => __( 'Remove featured image', DBM_CONTENT_TEXTDOMAIN ),
			//'use_featured_image'    => __( 'Use as featured image', DBM_CONTENT_TEXTDOMAIN ),
			//'insert_into_item'      => __( 'Insert into item', DBM_CONTENT_TEXTDOMAIN ),
			//'uploaded_to_this_item' => __( 'Uploaded to this item', DBM_CONTENT_TEXTDOMAIN ),
		}
		...
		public function create_taxonomy($system_name, $display_name, $hierarchical) {
			$new_taxonomy = new \DbmContent\OddCore\Admin\Taxonomies\CustomTaxonomy();
